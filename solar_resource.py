...
class SolarResource:
    ...
    def __init__(self,lat,lon,resource_year):
        """
        Input:
...
# Adhoc validation, can be removed if desired
# if __name__ == "__main__":
#     solar_resource = SolarResource(lat=35.2018863, lon=-101.945027, resource_year=2012)
#     test_df = pd.DataFrame.from_dict(solar_resource.data)
